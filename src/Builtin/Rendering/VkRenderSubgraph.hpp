#ifndef PENROSE_BUILTIN_RENDERING_VK_RENDER_SUBGRAPH_HPP
#define PENROSE_BUILTIN_RENDERING_VK_RENDER_SUBGRAPH_HPP
...
#endif // PENROSE_BUILTIN_RENDERING_VK_RENDER_SUBGRAPH_HPP
