#ifndef PENROSE_BUILTIN_VULKAN_RENDERING_VK_BUFFER_HPP
#define PENROSE_BUILTIN_VULKAN_RENDERING_VK_BUFFER_HPP
...
#endif // PENROSE_BUILTIN_VULKAN_RENDERING_VK_BUFFER_HPP
